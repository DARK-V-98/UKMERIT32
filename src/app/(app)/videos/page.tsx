    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Explore our collection of videos to master English.
        </p>
      </div>
          ...
          {filteredLessons.map((lesson) => (
            <Card key={lesson.id} className="flex flex-col overflow-hidden transition-transform transform hover:-translate-y-1 hover:shadow-xl">
              <CardHeader className="p-0">
                <Link href={`/videos/${lesson.id}`} className="block">
                  <Image
                    alt={lesson.title}
              ...
              <CardContent className="flex-1 p-4">
                ...
                <CardTitle className="text-lg">
                  <Link href={`/videos/${lesson.id}`} className="hover:text-primary transition-colors">
                    {lesson.title}
                  </Link>
                </CardTitle>
