    ...
    return (
       <div className="flex items-center justify-center min-h-[60vh]">
        <Card className="w-full max-w-md text-center">
            ...
            <CardContent>
              <Button variant="outline" className="w-full" onClick={() => router.back()}>Back to Video</Button>
            </CardContent>
        </Card>
      </div>
    )
        ...
        <Card className="w-full max-w-md text-center">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4">
                <Button variant="outline" className="w-full" onClick={() => router.back()}>Back to Video</Button>
                <Button className="w-full" onClick={() => router.push('/videos')}>Explore More Videos</Button>
              </div>
            </CardContent>
        </Card>
      </div>
